> **Historical README — commit `046d79a`.** This is the original project overview for the earlier 0.50 × 0.50 mm square-channel baseline. Its preliminary results, roadmap and starter commands are preserved as history, not the current final-study status. Only Markdown link targets were rebased for this folder; commands and code paths still assume the repository root. The final study uses 0.30 × 0.70 mm channels.
>
> [Current study](../../README.md) · [History and provenance](README.md)
